...
def download_excel(request):
    ...
    ##wb.save(output)
    out_file = session_data["request_id"] + "_STEP05-RNASeqLibraryPooling.xlsx"
...
def update_excel(data):
    ...
    if data['mult_requests']:
        ...
        ws['E12'] = data['plate_name']
        ws['E13'] = data['plate_id']
        ws['E14'] = req_info['library_completion_date']
        ws['E15'] = data['pool_name']
        ws['E16'] = data['pool_id']
        ws['E17'] = data['target_conc']
        ws['E18'] = data['pool_id']
        ws['E19'] = data['pool_id']
        ws['E20'] = data['pool_id']
        ws['E21'] = data['illumina_end']
        ws['E22'] = data['illumina_insert_size']
        ws['E23'] = data['pool_made_date']
